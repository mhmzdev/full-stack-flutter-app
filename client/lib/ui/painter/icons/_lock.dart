...
class LockIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint2Stroke.color = color ?? const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint3Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint3Stroke.color = color ?? const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint4Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint4Stroke.color = color ?? const Color(0xffABABAB).withOpacity(1.0);
