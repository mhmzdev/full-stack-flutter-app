...
class MoreIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Stroke.color = const Color(0xffAAACAB).withOpacity(1.0);
    ...
    Paint paint1Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.06000000;
    paint1Stroke.color = const Color(0xffAAACAB).withOpacity(1.0);
    ...
    Paint paint2Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.06000000;
    paint2Stroke.color = const Color(0xffAAACAB).withOpacity(1.0);
