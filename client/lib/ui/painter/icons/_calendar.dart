...
class CalendarIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint3Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.06250000;
    paint3Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    paint4Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint5Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint5Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint6Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint6Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint7Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint7Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint8Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint8Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
    ...
    Paint paint9Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.08333333;
    paint9Stroke.color = const Color(0xffABABAB).withOpacity(1.0);
