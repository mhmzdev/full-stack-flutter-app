...
class FacebookIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(size.width * 0.9999440, size.height * 0.2247975,
        size.width * 0.7794200, 0, size.width * 0.5073960, 0);
    path_0.close();

    Paint paint0Fill = Paint()..style = PaintingStyle.fill;
    paint0Fill.color = color ?? Colors.white.withOpacity(1.0);
